...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            PhotoImage(file="GIMP/stick/stick1_left.png"),
            PhotoImage(file="GIMP/stick/stick2_left.png"),
            PhotoImage(file="GIMP/stick/stick3_left.png")
        ]
        self.images_right = [
            PhotoImage(file="GIMP/stick/stick1.png"),
            PhotoImage(file="GIMP/stick/stick2.png"),
            PhotoImage(file="GIMP/stick/stick3.png")
        ]
        ...
        for sprite in self.game.sprites:
            ...
            if left and self.x < 0 and collided_left(co, sprite_co):
                ...
                if sprite.endgame:
                    ...
                    time.sleep(0.50)
                    self.PhotoImage_door_open = PhotoImage(file="GIMP/door/door open.png", width=40, height=35)
                    self.game.canvas.create_image(50, 30, anchor=NW, image=self.PhotoImage_door_open)
                    self.game.tk.update()
                    time.sleep(0.20)
                    self.game.canvas.delete(self.image)
                    # run #
                    self.image = self.game.canvas.create_image(70, 30, image=self.images_left[0], anchor="nw")
                    self.game.canvas.move(self.image, -3, 0)
                    self.game.tk.update()
                    time.sleep(0.20)
                    ...
                    self.PhotoImage_door_close = PhotoImage(file="GIMP/door/door close.png", width=40, height=35)
                    self.game.canvas.create_image(50, 30, anchor=NW, image=self.PhotoImage_door_close)
                    self.game.tk.update()
                    time.sleep(1)
...
class DoorSprite(Sprite):
    def __init__(self, game, photo_image, x, y, width, height):
        ...
        self.PhotoImage_door_close = photo_image
        self.image = game.canvas.create_image(x, y, image=self.PhotoImage_door_close, anchor="nw")
...
door = DoorSprite(g, PhotoImage(file="GIMP/door/door close.png"), 50, 30, 40, 35)
